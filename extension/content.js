    ...
    const bodySection = isCollapsed
      ...
      ${
        decisionState === "insufficient_data"
          ? `<section class="asa-alert warn">
          <h4 class="asa-section-title">Evidence Signal</h4>
          <div>Evidence is limited. Recommendation is conservative by design.</div>
        </section>`
          : ""
      }
    ...
    panel.innerHTML = `
      <header class="asa-header">
        ...
        <div class="asa-pill-row">
          ...
          <span class="asa-pill">Model ${escapeHtml(model)}</span>
        </div>
      </header>
